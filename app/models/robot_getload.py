    ...
    def run(self, *, output:bool=False) -> dict:
        ...
        # if True:
            ...
            for gran in self.all_gran_list:
                ...
                Metric.clear_table(db=self.db, granularity=gran, date_to=SysBf.tzdt(datetime_now - timedelta(days=granularity_settings['dblimit']), self.tz_str_system), tz_str_db=self.tz_str_db)
